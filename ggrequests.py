...
class TrendReq(object):
    ...
    def related_topics(self):
        ...
        for request_json in self.related_topics_widget_list:
            ...
            #kw = request_json['request']['restriction'][
                #'complexKeywordsRestriction']['keyword'][0]['value']  #This is commented to allow the empty key parameter
            kw=self.kw_list  #This is commented to allow the empty key parameter
            # convert to string as requests will mangle
    ...
    def related_queries(self):
        ...
        for request_json in self.related_queries_widget_list:
            ...
            #kw = request_json['request']['restriction'][
            #'complexKeywordsRestriction']['keyword'][0]['value'] #This is commented to allow the empty key parameter
            kw=self.kw_list #Directly assigning the input key list to the kw parameter 
            # convert to string as requests will mangle
            related_payload['req'] = json.dumps(request_json['request'])
            related_payload['token'] = request_json['token']
            related_payload['tz'] = self.tz
        ...
        try:
            ...
            rising_df = None
        for k in kw:
            result_dict[k] = {'top': top_df, 'rising': rising_df}
        return result_dict
